...
public final class Huffman {
    ...
    private static void serializeTree(HuffmanNode node) throws FileNotFoundException, IOException {
        ...
        try (ObjectOutputStream oosTree = new ObjectOutputStream(new FileOutputStream("C:\\Users\\morit\\Desktop\\Test\\tree"))) {
            try (ObjectOutputStream oosChar = new ObjectOutputStream(new FileOutputStream("C:\\Users\\morit\\Desktop\\Test\\char"))) {
    ...
    private static void serializeMessage(String message) throws IOException {
        ...
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\Users\\morit\\Desktop\\Test\\encodedMessage"))){
    ...
    private static HuffmanNode deserializeTree() throws FileNotFoundException, IOException, ClassNotFoundException {
        try (ObjectInputStream oisBranch = new ObjectInputStream(new FileInputStream("C:\\Users\\morit\\Desktop\\Test\\tree"))) {
            try (ObjectInputStream oisChar = new ObjectInputStream(new FileInputStream("C:\\Users\\morit\\Desktop\\Test\\char"))) {
    ...
    private static HuffmanNode preOrder(BitSet bitSet, ObjectInputStream oisChar, IntObject o) throws IOException {
        // created the node before reading what's registered.
    ...
    private static String decodeMessage(HuffmanNode node) throws FileNotFoundException, IOException, ClassNotFoundException {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("C:\\Users\\morit\\Desktop\\Test\\encodedMessage"))) {
